// Generated from c://Users//marci//Desktop//Structural Language//ParserRules.g4 by ANTLR 4.13.1
...
public class ParserRulesParser extends Parser {
	...
	public final FunctionContext function() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 20644379756L) != 0)) {
				{
				{
				setState(130);
				statement();
	...
	public final ForStatementContext forStatement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 8390764L) != 0)) {
				{
				setState(218);
				expression();
				}
	...
	public final SwitchStatementContext switchStatement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 21181250668L) != 0)) {
				{
				{
				setState(244);
				_errHandler.sync(this);
